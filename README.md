...
This will create a folder with the resolution, i.e., *1920x1080* (or *curvature*). Within that folder will be another subfolder with the core name, i.e., *MAME 2003 (0.78)*. Within the core subfolder the individual cfg files will be written in one of three subfolders named horizontal, vertical or all. When the script completes it will print the path where you should transfer the files within RetroPie.
