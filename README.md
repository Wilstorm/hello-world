...
This will create a folder with the resolution, i.e., *1920x1080* (or *curvature*). Within that folder will be a subfolder with the core name, i.e., *MAME 2003 (0.78)*. Within the core subfolder there will be one of three subfolders named all, horizontal or vertical, respectively, where the individual cfgs will be saved. When the script completes it will print the path where you should transfer the files within RetroPie.
